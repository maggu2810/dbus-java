...
public interface DBus extends DBusInterface {
    ...
    public interface Local extends DBusInterface {
        public class Disconnected extends DBusSignal {
            public Disconnected(final String path) throws DBusException {
                super(path);
            }
        }
    }
    ...
    public class NameOwnerChanged extends DBusSignal {
        ...
        public NameOwnerChanged(final String path, final String name, final String old_owner, final String new_owner)
    ...
    public class NameLost extends DBusSignal {
        ...
        public NameLost(final String path, final String name) throws DBusException {
            super(path, name);
            this.name = name;
        }
    ...
    public class NameAcquired extends DBusSignal {
        ...
        public NameAcquired(final String path, final String name) throws DBusException {
            super(path, name);
            this.name = name;
        }
    ...
    public interface Error {
        ...
        public class UnknownMethod extends DBusExecutionException {
            public UnknownMethod(final String message) {
                super(message);
            }
        }
        ...
        public class UnknownObject extends DBusExecutionException {
            public UnknownObject(final String message) {
                super(message);
            }
        }
        ...
        public class ServiceUnknown extends DBusExecutionException {
            public ServiceUnknown(final String message) {
                super(message);
            }
        }
        ...
        public class MatchRuleInvalid extends DBusExecutionException {
            public MatchRuleInvalid(final String message) {
                super(message);
            }
        }
    ...
    public interface Binding {
        ...
        public interface TestClient extends DBusInterface {
            ...
            public static class Trigger extends DBusSignal {
                ...
                public Trigger(final String path, final UInt16 a, final double b) throws DBusException {
                    super(path, a, b);
                    this.a = a;
                    this.b = b;
                }
        ...
        public interface TestSignals extends DBusInterface {
            ...
            public static class Triggered extends DBusSignal {
                ...
                public Triggered(final String path, final UInt64 a) throws DBusException {
                    super(path, a);
                    this.a = a;
                }
            }
        ...
        public final class TestStruct extends Struct {
            ...
            public TestStruct(final String a, final UInt32 b, final Short c) {
                this.a = a;
                this.b = b;
                this.c = c;
            }

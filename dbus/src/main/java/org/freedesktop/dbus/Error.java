...
public class Error extends Message {
    ...
    public Error(final String dest, final String errorName, final long replyserial, final String sig,
            final Object... args) throws DBusException {
        this(null, dest, errorName, replyserial, sig, args);
    }

    public Error(final String source, final String dest, final String errorName, final long replyserial,
    ...
    public Error(final String source, final Message m, final Throwable e) throws DBusException {
    ...
    public Error(final Message m, final Throwable e) throws DBusException {
    ...
    public DBusExecutionException getException() {
        try {
            ...
            final Constructor<? extends DBusExecutionException> con = c.getConstructor(String.class);
            DBusExecutionException ex;
            final Object[] args = getParameters();

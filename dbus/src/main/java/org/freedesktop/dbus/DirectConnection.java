...
public class DirectConnection extends AbstractConnection {
     ...
     *
     * @param address The address to connect to. This is a standard D-Bus address, except that the additional parameter
     *            'listen=true' should be added in the application which is creating the socket.
     */
    public DirectConnection(final String address) throws DBusException {
        super(address);
    ...
    DBusInterface dynamicProxy(final String path) throws DBusException {
        try {
            ...
            final RemoteObject ro = new RemoteObject(null, path, null, false);
    ...
    DBusInterface getExportedObject(final String path) throws DBusException {
     ...
     */
    public DBusInterface getRemoteObject(final String objectpath) throws DBusException {
        if (null == objectpath) {
     ...
     */
    public DBusInterface getRemoteObject(final String objectpath, final Class<? extends DBusInterface> type)
        ...
        final RemoteObject ro = new RemoteObject(null, objectpath, type, false);
        final DBusInterface i = (DBusInterface) Proxy.newProxyInstance(type.getClassLoader(), new Class[] { type },

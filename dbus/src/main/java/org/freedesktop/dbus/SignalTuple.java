...
class SignalTuple {
    ...
    public SignalTuple(final String type, final String name, final String object, final String source) {
        this.type = type;
        this.name = name;
        this.object = object;
        this.source = source;
    ...
    public boolean equals(final Object o) {
        ...
        final SignalTuple other = (SignalTuple) o;
    ...
    @Override
    public int hashCode() {
        return (null == type ? 0 : type.hashCode()) + (null == name ? 0 : name.hashCode())
                + (null == source ? 0 : source.hashCode()) + (null == object ? 0 : object.hashCode());
    }

...
class ArrayFrob {
    ...
    @SuppressWarnings("unchecked")
    public static <T> Object unwrap(final T[] ns) throws IllegalArgumentException {
        final Class<? extends T[]> ac = (Class<? extends T[]>) ns.getClass();
    ...
    public static <T> List<T> listify(final T[] ns) throws IllegalArgumentException {
        return Arrays.asList(ns);
    }

    @SuppressWarnings("unchecked")
    public static <T> List<T> listify(final Object o) throws IllegalArgumentException {
    ...
    @SuppressWarnings("unchecked")
    public static <T> T[] delist(final List<T> l, final Class<T> c) throws IllegalArgumentException {
        return l.toArray((T[]) Array.newInstance(c, 0));
    }

    public static <T> Object delistprimitive(final List<T> l, final Class<T> c) throws IllegalArgumentException {
        final Object o = Array.newInstance(c, l.size());
    ...
    @SuppressWarnings("unchecked")
    public static Object convert(final Object o, final Class<? extends Object> c) throws IllegalArgumentException {
        /*
    ...
    public static Object[] type(final Object[] old, final Class<Object> c) {
        final Object[] ns = (Object[]) Array.newInstance(c, old.length);
        for (int i = 0; i < ns.length; i++) {
            ns[i] = old[i];
        }
        return ns;
